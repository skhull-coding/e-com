...
const Searchbar = () => {
  ...
  return (
    ...
    >
      <input
        type="text"
        className="w-full 2xl:text-2xl text-base px-5 py-2 outline-none bg-[#CFEBEF] tracking-wide font-medium rounded-l-lg placeholder:font-thin placeholder:text-black/80"
